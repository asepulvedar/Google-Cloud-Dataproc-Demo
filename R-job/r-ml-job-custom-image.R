...
# Print the session information in format of R version, OS, and attached packages
print(sessionInfo())
...
nrows <- nrow(df_features)
train_indices <- base::sample(1:nrows, size = 0.8 * nrows)
